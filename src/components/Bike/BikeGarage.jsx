...
function BikeGarage() {
    ...
    const loadData = async () => {
        ...
        } catch (e) { console.error("Erreur garage:", e); } 
        ...
        <div className="bike-garage">
            ...
            <div className="bikes-grid">
                {filteredBikes.map(bike => {
                    ...
                    // --- CORRECTION : DÉFINITION DE hasFrame ---
                    // On vérifie si l'objet de style n'est pas vide
                    ...
                    return (
                        ...
                        >
                            <div className="bike-image-placeholder">
                                ...
                                {/* BOUTON GOMME (Visible si c'est mon vélo et qu'il a un cadre) */}
                                {isMine && hasFrame && (
                                    <button 
