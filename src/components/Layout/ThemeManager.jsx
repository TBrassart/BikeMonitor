...
const ThemeManager = ({ children }) => {
    ...
    useEffect(() => {
        // 1. On lance la synchro immédiatement
        syncThemeFromDB();
    ...
    const syncThemeFromDB = async () => {
        try {
            ...
            if (equippedSkin && equippedSkin.shop_items.asset_data) {
                ...
                // Pas de skin ? Reset aux valeurs par défaut
                resetTheme();
            }
        } catch (e) {
    ...
    const updateCssVariables = (data) => {
        ...
        if (data.primary) {
            ...
            // Recalcul des dégradés pour les boutons
        ...
        if (data.bg) {
            ...
            // Important : Appliquer au body pour éviter les flashs blancs
